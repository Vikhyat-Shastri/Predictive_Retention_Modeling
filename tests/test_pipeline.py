...
class TestFeatureEngineer:
    ...
    def test_feature_creation(self, sample_data):
        ...
        assert 'ServiceUsageScore' in result.columns or len(result.columns) >= len(sample_data.columns)
...
class TestChurnPredictionPipeline:
    ...
    def test_pipeline_initialization(self):
        ...
        pipeline = ChurnPredictionPipeline(model_type='rf', resampling_method='smoteenn')
...
class TestIntegration:
    ...
    def test_different_model_types(self, sample_data):
        ...
        for model_type in model_types:
            pipeline = ChurnPredictionPipeline(model_type=model_type, resampling_method=None)
            pipeline.train(X, y, cv_folds=2)
